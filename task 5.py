...
koef1 = create_mn(k1)
koef2 = create_mn(k2)
write_file("poly_1.txt", create_str(koef1))
write_file("poly_2.txt", create_str(koef2))
...
write_file("sum_poly.txt", create_str(lst_new))
with open('sum_poly.txt', 'r') as data:
    st3 = data.readlines()
